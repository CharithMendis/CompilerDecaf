...
public class SemanticErrorPrint {
    ...
    private void printFirstError(int line,int column){
        System.out.print("ERROR in \'" + filename + "\' at " + line + ":" + column + " - ");
    }
    
    private void printFirstWarning(int line,int column){
        System.out.print("WARNING in \'" + filename + "\' at " + line + ":" + column + " - ");
    }
    
    public void printWarningAboutCallout(int line,int column){
        printFirstWarning(line, column);
        System.out.println("callout methods return type cannot be resolved");
    }
